...
parseTHEStatementPDF(filePath, 'test.pdf').then(records => {
  ...
  if (uhcSample) console.log('UHC:', `${uhcSample.agent} | ${uhcSample.client} | $${uhcSample.commission}`);
  if (humanaSample) console.log('Humana:', `${humanaSample.agent} | ${humanaSample.client} | $${humanaSample.commission}`);
  if (aetnaSample) console.log('Aetna:', `${aetnaSample.agent} | ${aetnaSample.client} | $${aetnaSample.commission}`);
});
